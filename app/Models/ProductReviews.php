...
class ProductReviews extends Model
{
   ...
   use CreatedUpdatedBy;
    ...
    protected $fillable = ['partno','images_id','reviewsites_id','title','short_desc','type','web_link','seqno','is_highlight','remarks','created_by', 'created_at', 'updated_by', 'updated_at',];

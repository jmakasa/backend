...
class ReviewsitesHistory extends Model
{
    use HasFactory;
   // use UuidForKey;
...
//  protected $table = 'category';
    protected $table = 'reviewsites_history';
    ...
    protected $fillable = ['id','sitename', 'sitelogo', 'siteurl', 'docdir', 'country', 'lang', 'filetype', 'filesize', 'created_by', 'created_at', 'updated_by', 'updated_at', 'comment','status','bck_date','action'];

...
console.log(imgInfo);
							...
							if (isUpdateCaption && captionText) {
								...
								if ($parentAnchorLink.is('a')) {
									...
									$newFigure.append(`<figcaption class="${options.imageAttributes.figcaptionClass}" style="width:${imgInfo.width}"> ${captionText}</figcaption>`);
								} else {
									$newFigure = $img.wrap(`<figure class="${options.imageAttributes.figureClass}"></figure>`).parent();
									$img.after(`<figcaption class="${options.imageAttributes.figcaptionClass}" style="width:${imgInfo.width}">${captionText}</figcaption>`);
								}
							}
